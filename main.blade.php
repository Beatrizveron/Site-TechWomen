        ...
        <div class="menu">
           <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
               ...
               <li class="nav-item">
                 <a class="nav-link"  aria-current="page" href="#">Sobre o site</a>
               </li>
               <li class="nav-item">
                 <a class="nav-link" aria-current="page" href="#">História das Pioneiras</a>
               </li>
               <li class="nav-item">
                 <a class="nav-link " aria-current="page"    href="#" >Network</a>
               </li>
               <li class="nav-item">
                 <a class="nav-link "  aria-current="page"  href="#" >Midias</a>
               </li>
               <li class="nav-item">
    ...
    <footer id="contato">
      <div class="container">
        <div class="email">
          ...
          <h6 class="text-center mb-4">Entre em contato conosco</h6>
            <form class="row g-3">
              ...
              <div class="flex-grow-1 flex-md-grow-0 col-sm">
                <button type="submit" id= "edit_btn" class="btn btn-light button mb-3 d-md-inline d-block w-100">Enviar</button>
              </div>
             </form>
              </div>
              <div class="icon py-4">
