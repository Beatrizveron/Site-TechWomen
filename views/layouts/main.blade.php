    ...
    <header> 
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
               ...
               <li class="nav-item">
                <a class="nav-link"  aria-current="page" href="/Sobre">Sobre o site</a>
               </li>
               <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/Pioneiras">História das Pioneiras</a>
               </li>
               <li class="nav-item">
                <a class="nav-link " aria-current="page" href="/Network" >Network</a>
               </li>
               <li class="nav-item">
                <a class="nav-link "  aria-current="page" href="/Midias" >Midias</a>
               </li>
               <li class="nav-item">
        ...
        <div class="icon py-4">
            <div class="row">
                <div class="col-md-12 align-self-center text-right">
                  <ul>
                    <li>
                      <i class="bi bi-instagram" style="font-size: 20px; color: black;"></i>
                    </li>
                    <li>
                     <i class="bi bi-envelope" style="font-size: 20px; color: black;"></i>
                   </li>
                   <li>
                      <i class="bi bi-youtube" style="font-size: 20px; color: black;"></i>
                    </li>
                  </ul>
                </div>
            </div>
