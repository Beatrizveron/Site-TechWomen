    ...
    <div class="col-4" class="campo">
        ...
        @foreach [$events as event]
            <div class="card-body">
                ...
                <p class="card-description">{{$event->descriçãoV}}</p>
            </div>
        </div>               
    </div>
    <div class="col-4" >
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">{{$event->requisitos}}</p>
            </div>
        </div> 
    </div>
    <div class="col-4" >
        <div class="card">
            <div class="card-body">
              ...
              <p class="card-description">{{$event->beneficios}}</p>
            </div>
        </div> 
    </div>
</div>
