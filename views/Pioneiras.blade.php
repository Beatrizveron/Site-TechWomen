      ...
      <div  class = "row">
        <div class= "col-md-6 text-center">
          ...
          <div class= "col-md-6 text-right">
            <img src="imagens/pioneiras.svg" width="500" height="500">
          </div>
        </div>
      </div>
        <div id = "Info">
      ...
      <div class="col-lg-4 col-md-4 mb-4 mb-lg-0">
        <div class="card border-dark mb-3 text-center" style="max-width: 18rem; max-height: 22rem;">
            <div class="card-body text-dark">
              <a href ="/ada" class = "btn button-primay-outline btn-outline-primary button card-title"> <h4>Ada Lovelace</h4></a>
